...
public class PregnancyWellBeingImplementation implements PregnancyWellBeingPresenter, CommonPresenter.ReportInterface, ExpandableListView.OnGroupExpandListener {
   ...
   // private WellbeingReportAdapter generalWellBeingAdapter;
    ...
    List<TableDatum> tableDatumList;
    ...
    List<TableDatum> categoryTableData;

    public PregnancyWellBeingImplementation(Activity activity,
...
//            PAYMENT_CATEGORY = AppConstants.GENERAL_WELLBEING;
//        }
//        else if (dataManager.get(AppConstants.ROLE, "").equalsIgnoreCase(AppConstants.PROFILE_USER)) {
...
//                    }
//
//                        generalWellBeingCategoryAdapter = new WellbeingCategoryReportAdapter(activity, tableDatumCategoryList, com.happybeing.nsmiles.mvp.assessmentreport.pregnancywellbeing.PregnancyWellBeingImplementation.this);
...
//TODO : Call the different api for the corpporate wellbeing/
        ...
        Subscription subscription = service.getCorporateWellBeingCategoryReport(commonUtils.getTokenId(activity),
                MYURL,
                report_name,
                category,
                new Service.CorporateWellbeingReportCallBack() {
                    ...
                    public void onSuccess(CorporateWellbeingReportModel corporateWellBeingModel) {
                        ...
                        Log.i("WellbeingCategory","in on succes1 range is "+corporateWellBeingModel.getResult().getSuccess().getCorporatewellbeingv4Percentage());
                        ...
                        if(!hideRadar)
                        {
                            Log.i("WellbeingCategory", "In not hide radar");
                    ...
                    @Override
                    public void onError(NetworkError networkError) {
                        Log.i("WellbeingCategory","in on error"+networkError.getMessage());
