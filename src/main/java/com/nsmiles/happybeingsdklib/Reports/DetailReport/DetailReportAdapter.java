...
public class DetailReportAdapter extends BaseExpandableListAdapter {
    ...
    private TextView physicaloptions1,emotiontrigger,category_tv, range_tv,message_tv ,exp_range_tv,sub_content_tv,self_plan,things_workon,recommend_tips, first_step, reward_point, workOn,family1title;
    ...
    private String description="",str_physicalselected="",str_emotiontrigger="",str_recommend_tips="", message="" , exp_range="",faimlytitle1="",faimlytitle2="",faimlydescription1="", sub_content="",work_on="", firstStepString = "", rewardPointString = "", workOnString = "";
    ...
    public DetailReportAdapter(Activity activity, List<TableDatum> tableDatumList, DetailReportImplementation examPressureReportPresenter) {
...
//            }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup viewGroup) {
       ...
       // self_plan = convertView.findViewById(R.id.self_plan);
        ...
        //self_plan.setVisibility(View.VISIBLE);
    ...
    public class PicassoImageGetter implements Html.ImageGetter {
        ...
        public Drawable getDrawable(String source) {
            PicassoImageGetter.BitmapDrawablePlaceHolder drawable = new PicassoImageGetter.BitmapDrawablePlaceHolder();
